# besserlesenschreiben.at · Asset-Paket (Stand 14.09.2026)

## Inhalt
- logo/ — Wortmarke dreizeilig + einzeilig, je Weiß (transparent), Petrol (#2A9D8F, Web), Petrol-Print (#35B0A1), Schwarz (#1C2330). SVG (Text, braucht Nunito 900) und PNG -1x/-2x/-3x (Schrift eingebrannt, Schutzraum enthalten; 1x = 112 px Schriftgröße).
- svg/ — 12 Figuren als Master (ohne Bodenschatten), moods/ (8 Monster × 5 Stimmungen), posen/ (4 Haustiere × jubel/schlaf), tonal/ (einfarbig für Petrol-Flächen), logo/ (Wortmarke).
- avatare/ — 12 runde Kopf-Avatare (SVG).
- png/ — alle Figuren, Stimmungen, Posen in 256/512/1024 px; Avatare zusätzlich 64/128 px. Transparent.
