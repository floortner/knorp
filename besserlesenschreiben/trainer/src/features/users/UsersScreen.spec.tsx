...
let me: StaffMe = { trainerId: 'r1', name: 'Owner', role: 'admin', email: 'owner@team.test', createdAt: '2026-01-01T00:00:00.000Z' };
vi.mock('@/features/auth/auth-context', () => ({ useStaffAuth: () => ({ trainer: me }) }));
...
beforeEach(() => {
  vi.clearAllMocks();
  me = { trainerId: 'r1', name: 'Owner', role: 'admin', email: 'owner@team.test', createdAt: '2026-01-01T00:00:00.000Z' };
});
...
describe('UsersScreen', () => {
  ...
  it('hides the admin surface from a plain trainer', async () => {
    me = { trainerId: 'r2', name: 'Rev', role: 'trainer', email: 'rev@team.test', createdAt: '2026-01-01T00:00:00.000Z' };
    renderUsers();
