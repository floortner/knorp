...
/**
 * Editable copy of the analysis. Starts as the LLM draft; the trainer corrects it into the
 * authoritative verdict. Per-item the trainer flips correct/incorrect and adjusts the error type;
