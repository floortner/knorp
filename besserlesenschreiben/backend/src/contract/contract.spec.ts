...
/**
 * Drift gate: the golden frontend fixtures (the render targets for the 12 exercise renderers and the
 * /units home) must satisfy the backend contract schemas that publish the OpenAPI. If the contract and
 * the fixtures diverge, this fails before the frontend types do.
 */
