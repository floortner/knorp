  ...
  profiles: [
    {
      ...
      dyslexicFont: false, fontScale: 1, appearance: 'auto', stars: 240, streakDays: 3, jokerAvailable: true, unlockedUnit: 1,
...
const progress = {
  streakDays: 3, jokerAvailable: true, stars: 240, weeklyActivity: [0, 0, 0, 0, 0, 0, 0],
